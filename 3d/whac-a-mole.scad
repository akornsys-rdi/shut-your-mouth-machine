        ...
        union() {
            ...
            translate([4, 0, 0]) union() {
                union() {
                    difference() {
                        union() {
                            translate([6, 12, 0]) cube([180, 110.5, 6]);
                        }
                        union() {
                    ...
                    translate([57, 12, 0]) cube([10, 10, 10]);
                    translate([114, 12, 0]) cube([10, 10, 10]);
                    translate([6, 12, 0]) cube([37, 30, 6]);
                }
                *union() {
                    difference() {
                        union() {
                            translate([6, 112.5, 0]) cube([180, 102.5, 6]);
                        }
                        union() {
                    ...
                    translate([42, 205, 0]) cube([10, 10, 10]);
                    translate([140, 205, 0]) cube([10, 10, 10]);
                    translate([96, 172, 0]) difference() {
        ...
        union() {
            ...
            union() {
                ...
                *translate([113, 117.5, 98]) rotate([0, 0, 0]) screw_clearance();
                //lateral inferior
                translate([70, -0.5, 5]) rotate([-90, 0, 0]) screw_clearance();
                translate([127, -0.5, 5]) rotate([-90, 0, 0]) screw_clearance();
                *translate([59.5, -0.5, 103]) rotate([-90, 0, 0]) screw_clearance();
                *translate([110.5, -0.5, 103]) rotate([-90, 0, 0]) screw_clearance();
                //lateral superior
                translate([51, 225.5, 5]) rotate([90, 0, 0]) screw_clearance();
                translate([149, 225.5, 5]) rotate([90, 0, 0]) screw_clearance();
                ...
                *translate([130.5, 225.5, 103]) rotate([90, 0, 0]) screw_clearance();
                ...
                translate([-0.5, 90, 5]) rotate([0, 90, 0]) screw_clearance();
                translate([-0.5, 120, 5]) rotate([0, 90, 0]) screw_clearance();
                ...
                *translate([3, 112.25, -1]) cylinder(r=0.875, h=110);
                //lateral izquierdo
                translate([200.5, 5, 27]) rotate([0, -90, 0]) screw_clearance();
                translate([200.5, 5, 81]) rotate([0, -90, 0]) screw_clearance();
                translate([200.5, 90, 5]) rotate([0, -90, 0]) screw_clearance();
                translate([200.5, 120, 5]) rotate([0, -90, 0]) screw_clearance();
